    ...
    create  table
      "staging"."ods"."ods_prescription_enrichie__dbt_tmp"
...
with prescriptions as (
    select * from "staging"."staging"."stg_prescription"
),

medicaments as (
    select * from "staging"."staging"."stg_medicaments"
),

consultations as (
    select * from "staging"."ods"."ods_consultation_enrichie"
),
