{{
    config(
        materialized='table',
        tags=['datamart', 'territoriale', 'deces', 'satisfaction']
    )
}}
...
final as (
    ...
    -- UNION ALL supprimé pour éviter les conflits de clés
    -- Les départements seront ajoutés dans une table séparée si nécessaire
)
