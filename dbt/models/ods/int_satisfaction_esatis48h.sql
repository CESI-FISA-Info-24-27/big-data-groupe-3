...
with esatis48h_2020 as (
    select
        ...
        -- Même logique que 2017 : tout caster en varchar
    ...
    from {{ source('raw', 'satisfaction_2020_resultats_esatis48h_mco_open_data_2020') }}
...
esatis48h_2019 as (
    select
        ...
        nb_reco_brut as nb_recommandations
    from {{ source('raw', 'satisfaction_2019_resultats_esatis48h_mco_open_data_2019') }}
    where finess is not null
),
...
esatis48h_2017 as (
    ...
    from {{ source('raw', 'satisfaction_esatis48h_mco_recueil2017_donnees') }}
    where finess is not null
),

all_esatis48h as (
    select * from esatis48h_2020
    union all
